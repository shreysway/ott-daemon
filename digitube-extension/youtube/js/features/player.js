...
14.0 Custom plyaer buttons
	...
	14.3 Rotate
    14.4 Popup player
15.0 Player Control Change video
    15.1 Play Video
    15.2 Pause Video
    15.3 Stop Video
    15.4 Seek Video
    15.5 Update Video Status 
    15.6 Forward Video
	15.7 Rewind Video
-----------------------------------------------------------------------------*/
...
ImprovedTube.change_video = function(videoId){
    let script = `if(document.querySelector(".html5-video-player")){
        document.querySelector(".html5-video-player").loadVideoById("${videoId}");
    }`;
    injectScript(script);
}
...
ImprovedTube.play_video = function(){
    let script = `if(document.querySelector(".html5-video-player")){
...
ImprovedTube.pause_video = function(){
    let script = `if(document.querySelector(".html5-video-player")){
        document.querySelector(".html5-video-player").pauseVideo();
    }`;
    injectScript(script);
}
...
ImprovedTube.stop_video = function(){
    let script = `if(document.querySelector(".html5-video-player")){
...
ImprovedTube.seek_video = function(seconds){
    let script = `if(document.querySelector(".html5-video-player")){
        document.querySelector(".html5-video-player").seekTo(${seconds}, true);
    }`;
    injectScript(script);
}
...
ImprovedTube.update_video_status = function(){
    let script = `if(document.querySelector(".html5-video-player")){
        var digiPlayer = document.querySelector(".html5-video-player");
        var state = digiPlayer.getPlayerState();
        var videoData = digiPlayer.getVideoData();
        var duration = digiPlayer.getDuration();
        var position = digiPlayer.getCurrentTime();
        var playerData = {
...
ImprovedTube.forward_video = function(fastForwardTime){
    let script = `if(document.querySelector(".html5-video-player")){
        let digiPlayer = document.querySelector(".html5-video-player");
        let duration = digiPlayer.getCurrentTime();
        duration += ${fastForwardTime};
        document.querySelector(".html5-video-player").seekTo(duration, true);
    }`;
    injectScript(script);
}
...
ImprovedTube.rewind_video = function(fastForwardTime){
    let script = `if(document.querySelector(".html5-video-player")){
        let digiPlayer = document.querySelector(".html5-video-player");
        let duration = digiPlayer.getCurrentTime();
        duration -= ${fastForwardTime};
...
ImprovedTube.set_fullscreen = function(fastForwardTime){
    let script = `if(document.querySelector(".html5-video-player")){
        var goFS = document.createElement("button");
        goFS.addEventListener("click", function() {
            let digiPlayer = document.querySelector(".html5-video-player");
            digiPlayer.requestFullscreen()
        }, false);
        goFS.click();
    }`;
    injectScript(script);
...
ImprovedTube.skipAdd = function(){
    let script = `var videoObj = document.querySelector('.html5-main-video');
    var duration = videoObj.getDuration();
    videoObj.currentTime = duration;`;
    injectScript(script);
}